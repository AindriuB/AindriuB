...
Java · Distributed Systems · Enterprise Architecture · AI Infrastructure

I'm a software engineer with experience across financial services
and public-sector systems, currently focused on building reliable,
...
### Data Prism
Privacy-preserving enterprise data access for AI agents.

### JResolve
Java 8 entity-resolution and record-linkage library.

### F1 Simulator Engine
On-device probabilistic F1 championship simulation engine.

## Background
### Large-scale public-sector digital services
Senior Software Engineer / Technical Lead working on mission-critical government systems processing highly sensitive citizen and financial data. Designed and delivered distributed Java/Spring services integrating multiple internal platforms and legacy systems, with responsibility spanning API design, domain modelling, system integration, production support and technical architecture.
